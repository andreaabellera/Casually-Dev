...
<style>
    ...
    #nav-chezmoi section{
        background-image: url(https://4everland.io/ipfs/bafybeigkiyocbout26eshome3yvbq7pb2ybif5afsy6u4h56tidkidtvhi);
    }

    #nav-blog section{
        background-image: url(https://4everland.io/ipfs/bafybeic7uxidilpwenka7pkc6ze3ubbtzt75geqbs62jhi4pxfaiaxqs3y);
    }

    #nav-galerie section{
        background-image: url(https://4everland.io/ipfs/bafybeicbzg74h32pofcjhlldhfzr5eyuizxmvnizlfffoxnhkybatwu5bq);
    }

    #nav-archive section{
        background-image: url(https://4everland.io/ipfs/bafybeiemaommpsincjhizl2ppv26rnbcgxavmrhvhjxr5wr5o6xetqhifm);
    }

    #nav-resources section{
        background-image: url(https://4everland.io/ipfs/bafybeig2afgdlpkc3end3mhmnrl23itdyoofsk3dmbpyf4rznzpwgotbbq);
    }

    #nav-revues section{
        background-image: url(https://4everland.io/ipfs/bafybeihnlbqpr3shznqunbsqh73quw2qwgltvlyftqnayzg3nvv36553xy);
    }

    #nav-andrea section{
        background-image: url(https://4everland.io/ipfs/bafybeidfxeswhhjzirsa7pbjflifmd3knt6wy3cu5isxf2mrq7inzdhpl4);
    }
